...
const mongoURI = process.env.MONGO_URL || 'mongodb+srv://mdsarfraaznasir_db_user:c1*******@cluster0.6zjy2ss.mongodb.net/?appName=Cluster0';

if (!process.env.MONGO_URL) {
  console.warn("Warning: MONGO_URL environment variable not found. Falling back to the default hardcoded URI.");
}
